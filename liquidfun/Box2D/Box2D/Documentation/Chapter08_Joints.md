...
&nbsp;&nbsp;&nbsp;`b2RevoluteJoint* joint = (b2RevoluteJoint*)myWorld->CreateJoint(&jointDef);`<br/>
&nbsp;&nbsp;&nbsp;`… do stuff …`<br/>
...
<img align="center" src="image_18.gif" alt="Distance joint" height="118" width="155"><br/>
...
&nbsp;&nbsp;&nbsp;`jointDef.Initialize(myBodyA, myBodyB, worldAnchorOnBodyA, worldAnchorOnBodyB);`<br/>
...
<img align="center" src="image_19.gif" alt="Revolute joint" height="97" width="139"><br/>
...
&nbsp;&nbsp;&nbsp;`b2RevoluteJointDef jointDef;`<br/>
&nbsp;&nbsp;&nbsp;`jointDef.Initialize(myBodyA, myBodyB, myBodyA->GetWorldCenter());`<br/>

The revolute joint angle is positive when bodyB rotates CCW about the angle point. Like all angles in LiquidFun, the revolute angle is measured in radians. By convention the revolute joint angle is zero when the joint is created using Initialize(), regardless of the current rotation of the two bodies.
...
&nbsp;&nbsp;&nbsp;`... Game Loop Begin ...`<br/>
&nbsp;&nbsp;&nbsp;`float32 angleError = myJoint->GetJointAngle() - angleTarget;`<br/>
...
<img align="center" src="image_20.gif" alt="Prismatic joint" height="134" width="165"><br/>
...
&nbsp;&nbsp;&nbsp;`jointDef.Initialize(myBodyA, myBodyB, myBodyA->GetWorldCenter(), worldAxis);`<br/>
...
<img align="center" src="image_21.gif" alt="Pulley joint" height="213" width="237"><br/>
...
&nbsp;&nbsp;&nbsp;`jointDef.Initialize(myBody1, myBody2, groundAnchor1, groundAnchor2, anchor1, anchor2, ratio);`<br/>
...
<img align="center" src="image_22.gif" alt="Gear joint" height="188" width="179"><br/>
...
<img align="center" src="image_23.png" alt="Wheel joint" height="286" width="157"><br/>
...
It is tempting to use the weld joint to define breakable structures. However, the LiquidFun solver is iterative so the joints are a bit soft. So chains of bodies connected by weld joints will flex.
